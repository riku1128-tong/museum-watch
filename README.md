...
- 見どころ: 館のページに「この美術館の見どころ」、展覧会に「おすすめポイント」（巡回のときに Claude が公式サイトの情報をもとに要約。AI による要約と明記）
- 特集: 会期終了間近の展覧会・これから始まる展覧会・無料開放日カレンダー・夜遅くまで開いている美術館（毎週自動更新）
- スマホ: ホーム画面に追加すると、アプリのように全画面で使えます（下にタブバー、一度見たページはオフラインでも表示）
